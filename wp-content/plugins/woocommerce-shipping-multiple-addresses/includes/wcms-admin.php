...
class WC_MS_Admin {
	...
	public static function edit_user_scripts() {
		...
		wp_enqueue_script( 'wcms-country-select', plugins_url( 'js/country-select.js', WC_Ship_Multiple::FILE ), array( 'jquery' ), WC_VERSION, true );
		...
		wp_enqueue_script( 'wcms-edit-user', plugins_url( 'js/user-edit.js', WC_Ship_Multiple::FILE ), array( 'jquery' ), WC_VERSION, true );
	}
