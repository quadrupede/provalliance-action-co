    ...
    function display_order_shipping_addresses( $order ) {
        ...
        foreach ( $packages as $x => $package ) {
            ...
            $address = ( isset( $package['destination'] ) && ! empty( $package['destination'] ) )
                ? $woocommerce->countries->get_formatted_address( $package['destination'] )
                : '';
        ...
        <table cellspacing="0" cellpadding="0" style="width: 100%; vertical-align: top;" border="0">
            <tr>
                ...
                <td valign="top" width="50%">
                    ...
                    <?php
                    echo '<div class="shipping_data"><div class="address">'. $woocommerce->countries->get_formatted_address( $package['destination'] ) .'</div><br />';
