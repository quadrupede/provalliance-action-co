...
$packages_shipping_methods  = get_post_meta( $order->id, '_shipping_methods', true );
            ...
            <?php if ($action == 'print_invoice') { ?>
                <table>
                        ...
                        <td style="text-align:left;"><?php
                            ...
                            if ( empty( $order_method ) ) {
                                ...
                                if ( $order_method['cost'] > 0 ) {
                                    ...
                                    $shipping = wc_price( $order_method['cost'], array('currency' => $order->get_order_currency()) );

                                    $shipping .= sprintf( __( '&nbsp;<small>via %s</small>', 'woocommerce' ), $order_method['name'] );
                    ...
                    <tr>
                        ...
                        <td style="text-align:left;"><?php echo wc_price($package['contents_cost'] + $order_method['cost']); ?> <?php _e('- via', 'woocommerce-pip'); ?> <?php echo ucwords($order->payment_method_title); ?></td>
                    </tr>
                    </tfoot>
                    <tbody>
                    <?php
